...
def jobs_api():
    ...
    with get_db() as conn:
        conn.execute(
            ...
            (
                sanitize_text(data.get('title'), 200),
                sanitize_text(data.get('company'), 200),
                sanitize_text(data.get('location'), 200),
                sanitize_text(data.get('type', 'Full-time'), 50),
                sanitize_text(data.get('salary'), 100),
                sanitize_text(data.get('skills'), 500),
                sanitize_text(data.get('description'), 5000),
                'Active',
    ...
    with get_db() as conn:
        conn.execute(
            ...
            (
                ...
                sanitize_text(data.get('company'), 200),
                sanitize_text(data.get('location'), 200),
                sanitize_text(data.get('type'), 50),
                sanitize_text(data.get('salary'), 100),
                sanitize_text(data.get('skills'), 500),
                sanitize_text(data.get('description'), 5000),
                job_id
